...
## -------------------------------------------------------------------------
##### 5. Bloque de Segmentación mediante Modelo RFM 12M  #####
...
#I can appreciate a pretty clear elbow at k = 3, indicating that 3 is the best number of clusters.
